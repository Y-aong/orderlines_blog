import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as t}from"./app-58fd5dfd.js";const e={},p=t(`<h1 id="flask-with上下文" tabindex="-1"><a class="header-anchor" href="#flask-with上下文" aria-hidden="true">#</a> flask with上下文</h1><p>例子，如果你想在flask中直接使用db,你会得到一个经典错误</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">from</span> app<span class="token punctuation">.</span>models<span class="token punctuation">.</span>base <span class="token keyword">import</span> db
