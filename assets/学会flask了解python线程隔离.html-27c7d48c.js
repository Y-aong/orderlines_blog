import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o as p,c as o,a as n,b as c,d as l,e as s}from"./app-48200f17.js";const i={},u=s(`<h1 id="flask中的线程隔离" tabindex="-1"><a class="header-anchor" href="#flask中的线程隔离" aria-hidden="true">#</a> flask中的线程隔离</h1><h2 id="问题-flask中会接收多个请求-那他们不会搞混吗" tabindex="-1"><a class="header-anchor" href="#问题-flask中会接收多个请求-那他们不会搞混吗" aria-hidden="true">#</a> 问题：flask中会接收多个请求，那他们不会搞混吗？</h2><p>Flask内部，通过维护一个dict来实现线程隔离。伪代码如下 <code>request={thread_key1:Request1,thread_key2:Request2}</code> 其中thread_key是线程的唯一id号，Request就是每次请求的Request对象</p><p>Flask内部引入了一个werkzeug的库，这个库里有一个local模块，里面有一个Local对象，Flask内部线程隔离就是通过操作Local对象实现的。</p><h2 id="local对象" tabindex="-1"><a class="header-anchor" href="#local对象" aria-hidden="true">#</a> Local对象</h2><p>Local对象实际上就是对字典原理的一个封装</p><p>class Local(object):<br><strong>slots</strong> = (&#39;<strong>storage</strong>&#39;, &#39;<strong>ident_func</strong>&#39;)</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">__init__</span><span class="token punctuation">(</span>self<span class="token punctuation">)</span><span class="token punctuation">:</span>
