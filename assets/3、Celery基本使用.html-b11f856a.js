import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-01aedd85.js";const t="/orderlines_blog/assets/images/image-20250317145513794.png",p={},o=e(`<h1 id="_3、celery基本使用" tabindex="-1"><a class="header-anchor" href="#_3、celery基本使用" aria-hidden="true">#</a> 3、Celery基本使用</h1><h3 id="引言" tabindex="-1"><a class="header-anchor" href="#引言" aria-hidden="true">#</a> 引言</h3><p>在现代Web应用中，异步任务处理是提升用户体验和系统性能的关键。例如，发送邮件、生成报表、处理文件上传等操作，如果同步执行会阻塞用户请求，影响响应速度。<strong>Celery</strong> 是一个基于Python的分布式任务队列（也称为异步任务框架），它允许我们将耗时操作交给后台执行，从而解放主线程，提升应用的响应能力。</p><p>本文将从基础用法、配置到注意事项，手把手教你如何在Python项目中使用Celery，并规避常见问题。</p><h3 id="一、安装与配置" tabindex="-1"><a class="header-anchor" href="#一、安装与配置" aria-hidden="true">#</a> 一、安装与配置</h3><h4 id="_1-安装依赖" tabindex="-1"><a class="header-anchor" href="#_1-安装依赖" aria-hidden="true">#</a> 1. 安装依赖</h4><p>Celery需要一个消息中间件（Broker）来传递任务，常用的有 <strong>RabbitMQ</strong> 和 <strong>Redis</strong>。这里以Redis为例：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>pip <span class="token function">install</span> celery redis
