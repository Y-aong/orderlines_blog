import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,e as s}from"./app-58fd5dfd.js";const a={},d=s(`<h1 id="redis2、quicklist和sds" tabindex="-1"><a class="header-anchor" href="#redis2、quicklist和sds" aria-hidden="true">#</a> redis2、quickList和SDS</h1><h3 id="quicklist定义" tabindex="-1"><a class="header-anchor" href="#quicklist定义" aria-hidden="true">#</a> quickList定义</h3><p>list用quicklist来存储，quicklist存储了一个双向链表，每个节点都是一个ziplist</p><figure><img src="https://hunter-image.oss-cn-beijing.aliyuncs.com/redis/quicklist/QuickList.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>在低版本的Redis中，list采用的底层数据结构是ziplist+linkedList；</p><p>高版本的Redis中底层数据结构是quicklist(它替换了ziplist+linkedList)，而quicklist也用到了ziplist</p><h3 id="sds定义" tabindex="-1"><a class="header-anchor" href="#sds定义" aria-hidden="true">#</a> SDS定义</h3><p>Redis 没有直接使用 C 语言传统的字符串表示（以空字符结尾的字符数组，以下简称 C 字符串）， 而是自己构建了一种名为简单动态字符串（simple dynamic string，SDS）的抽象类型， 并将 SDS 用作 Redis 的默认字符串表示。</p><h3 id="sds-代码的定义" tabindex="-1"><a class="header-anchor" href="#sds-代码的定义" aria-hidden="true">#</a> SDS 代码的定义</h3><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token keyword">struct</span> <span class="token class-name">sdshdr</span> <span class="token punctuation">{</span>
