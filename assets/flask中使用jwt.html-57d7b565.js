import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as t}from"./app-58fd5dfd.js";const p={},e=t(`<h1 id="flask中使用jwt" tabindex="-1"><a class="header-anchor" href="#flask中使用jwt" aria-hidden="true">#</a> flask中使用jwt</h1><p>关于jwt的特点上一篇博客已经有所介绍</p><p>这里拿flask举例说明</p><h3 id="下载" tabindex="-1"><a class="header-anchor" href="#下载" aria-hidden="true">#</a> 下载</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>pip install PyJWT==2.3.0
