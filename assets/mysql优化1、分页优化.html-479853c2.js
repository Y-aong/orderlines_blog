import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as s,e as n}from"./app-01aedd85.js";const d={},l=n(`<h1 id="_21、分页优化" tabindex="-1"><a class="header-anchor" href="#_21、分页优化" aria-hidden="true">#</a> 21、分页优化</h1><h3 id="一、分页的实现" tabindex="-1"><a class="header-anchor" href="#一、分页的实现" aria-hidden="true">#</a> 一、分页的实现</h3><p>一般的分页查询使用简单的 limit 子句就可以实现。limit 格式如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>SELECT * FROM 表名 LIMIT [offset,] rows
