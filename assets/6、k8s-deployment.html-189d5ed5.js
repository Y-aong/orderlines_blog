import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as t,c as r,a as e,b as n,d as i,e as a}from"./app-58fd5dfd.js";const o={},c=a(`<h1 id="_6、k8d-deployment" tabindex="-1"><a class="header-anchor" href="#_6、k8d-deployment" aria-hidden="true">#</a> 6、k8d_deployment</h1><h3 id="一、定义" tabindex="-1"><a class="header-anchor" href="#一、定义" aria-hidden="true">#</a> 一、定义</h3><p>deployment为pod是和replicaSets提供声明式更新的能力。Delpoyment就是将实际状态变为期望状态的能力</p><h3 id="二、deployment的特点" tabindex="-1"><a class="header-anchor" href="#二、deployment的特点" aria-hidden="true">#</a> 二、deployment的特点</h3><ul><li>赋予Pod自愈和故障转移能力</li><li>水平扩容</li><li>灰度发布</li><li>滚动更新</li></ul><p>三、deployment-spec的字段</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>FIELDS:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="四、deployment规约" tabindex="-1"><a class="header-anchor" href="#四、deployment规约" aria-hidden="true">#</a> 四、deployment规约</h3>`,8),p={href:"https://kubernetes.io/zh-cn/docs/concepts/workloads/controllers/deployment/#pod-template",target:"_blank",rel:"noopener noreferrer"},m=a(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.spec 中只有 .spec.template 和 .spec.selector 是必需的字段。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="五、deployment-回滚解释" tabindex="-1"><a class="header-anchor" href="#五、deployment-回滚解释" aria-hidden="true">#</a> 五、deployment 回滚解释</h3><p>一个deployment产生三个资源</p><ul><li>deployment资源：Deployment控制RS，RS控制Pod的副本数。每部署一个新版本就会创建一个新的副本集，利用他记录状态，回滚也是直接让指定的rs生效</li><li>ReplicaSet： 只提供了副本数量的控制功能</li><li>Pod资源：这次部署实际的运行的内容</li></ul><h3 id="六、deployment更新机制" tabindex="-1"><a class="header-anchor" href="#六、deployment更新机制" aria-hidden="true">#</a> 六、deployment更新机制</h3><ul><li>仅当 Deployment Pod 模板（即 <code>.spec.template</code>）发生改变时，例如<strong>模板的标签或容器镜像被更新， 才会触发 Deployment 上线</strong>。 <strong>其他更新（如对 Deployment 执行扩缩容的操作）不会触发上线动作。</strong></li><li><strong>上线动作 原理： 创建新的rs，准备就绪后，替换旧的rs（此时不会删除，因为<code>revisionHistoryLimit</code> 指定了保留几个版本）</strong></li></ul><p>部署回滚常用命令</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">################更新#################################</span>
