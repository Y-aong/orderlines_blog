import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as i,c as o,a as n,b as a,d as l,e as s}from"./app-48200f17.js";const c={},u=s(`<h1 id="python-编程风格指南" tabindex="-1"><a class="header-anchor" href="#python-编程风格指南" aria-hidden="true">#</a> python 编程风格指南</h1><h3 id="变量名" tabindex="-1"><a class="header-anchor" href="#变量名" aria-hidden="true">#</a> 变量名</h3><p><strong>变量名总体要求</strong></p><ol><li><p>尽可能使用<strong>有意义的英文单词</strong>给变量命名，禁止使用单字母作为变量【强制】</p><p><strong>反例</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>a <span class="token operator">=</span> <span class="token string">&#39;杨勇&#39;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></li></ol><ul><li>模块名 ——模块名统一使用下划线命名<code>redis_utils</code></li><li>类名——类名统一使用大驼峰命名<code>Person</code></li><li>函数名——统一使用下划线命名<code>get_name</code></li><li>变量名——统一使用下划线命名<code>my_name</code></li></ul><h3 id="导入" tabindex="-1"><a class="header-anchor" href="#导入" aria-hidden="true">#</a> 导入</h3><ul><li><p>少用<code>import *</code>，少导入不用的代码，避免循环导入【建议】</p></li><li><p>导入格式，每个导入应该独占一行 【建议】</p><p>导入总应该放在文件顶部, 位于模块注释和文档字符串之后, 模块全局变量和常量之前. 导入应该按照从最通用到最不通用的顺序分组，每种顺序之间添加一个空行</p><ul><li><p>标准库导入</p></li><li><p>第三方库导入</p></li><li><p>应用程序指定导入</p></li></ul><p>每种分组中, 应该根据每个模块的完整包路径按字典序排序, 忽略大小写.</p><p><strong>反例</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">from</span> flask <span class="token keyword">import</span> Resquese
...
<span class="token keyword">from</span> foo<span class="token punctuation">.</span>bar <span class="token keyword">import</span> baz
<span class="token keyword">from</span> foo<span class="token punctuation">.</span>bar <span class="token keyword">import</span> Quux
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h3 id="注释" tabindex="-1"><a class="header-anchor" href="#注释" aria-hidden="true">#</a> 注释</h3>`,8),d=s(`<li><p>文件头设置【强制】</p><p>所有的文件强制添加以下文件头，其中替换为自己的名字，<strong>Description</strong>必写</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># !/usr/bin/env python</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>使用<code>dataclasses</code>数据类，使用<code>pydantic</code>类型提示类，自行百度</li></ul></li><li><p>拒绝函数具有隐式返回值</p><p>反例：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">demo</span><span class="token punctuation">(</span>num<span class="token punctuation">:</span> <span class="token builtin">int</span><span class="token punctuation">)</span> <span class="token operator">-</span><span class="token operator">&gt;</span> <span class="token builtin">int</span><span class="token punctuation">:</span>
    <span class="token triple-quoted-string string">&quot;&quot;&quot;
    测试隐私返回值方法
    @param num: 
    @return: 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>异常解析：函数正常情况下返回值为int类型，但是参数小于10时，返回值为None,这时如果使用函数返回值可能会有一些意料之外的结果。</p><p>正例</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">demo</span><span class="token punctuation">(</span>num<span class="token punctuation">:</span> <span class="token builtin">int</span><span class="token punctuation">)</span> <span class="token operator">-</span><span class="token operator">&gt;</span> <span class="token builtin">int</span><span class="token punctuation">:</span>
    <span class="token triple-quoted-string string">&quot;&quot;&quot;
    测试隐私返回值方法
    @param num: 
    @return: 
...
<span class="token keyword">print</span><span class="token punctuation">(</span>zs<span class="token punctuation">.</span>_sex<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>随意为类添加属性</p><p>反例</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">Person</span><span class="token punctuation">:</span>
    <span class="token keyword">def</span> <span class="token function">__init__</span><span class="token punctuation">(</span>self<span class="token punctuation">,</span> name<span class="token punctuation">,</span> age<span class="token punctuation">)</span><span class="token punctuation">:</span>
        self<span class="token punctuation">.</span>name <span class="token operator">=</span> name
        self<span class="token punctuation">.</span>age <span class="token operator">=</span> age
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>正例</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">Person</span><span class="token punctuation">:</span>
    <span class="token keyword">def</span> <span class="token function">__init__</span><span class="token punctuation">(</span>self<span class="token punctuation">,</span> name<span class="token punctuation">,</span> age<span class="token punctuation">)</span><span class="token punctuation">:</span>
        self<span class="token punctuation">.</span>name <span class="token operator">=</span> name
        self<span class="token punctuation">.</span>age <span class="token operator">=</span> age
    ...
    <span class="token keyword">def</span> <span class="token function">set_sex</span><span class="token punctuation">(</span>self<span class="token punctuation">,</span> sex<span class="token punctuation">:</span> <span class="token builtin">str</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
        <span class="token triple-quoted-string string">&quot;&quot;&quot;设置性别&quot;&quot;&quot;</span>
        self<span class="token punctuation">.</span>sex <span class="token operator">=</span> sex
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>类的继承和类的组合，尽量少用类的多继承，多使用类的组合</p><p>类的多继承是保证类的多态性，但是过长的继承规则，不利于写代码和业务调试，类的组合也是符合很多设计模式的思路。</p></li></ul><h3 id="模块设计" tabindex="-1"><a class="header-anchor" href="#模块设计" aria-hidden="true">#</a> 模块设计</h3><ul><li>模块解耦，各个功能的模块要明确</li><li>公共方法的提取，公共方法要进行方法的抽取</li></ul><h3 id="其他" tabindex="-1"><a class="header-anchor" href="#其他" aria-hidden="true">#</a> 其他</h3><ul><li><p>数据类不要过于凌乱</p></li><li><p>过多的重复代码</p></li><li><p>没有注释或者令人困惑的注释</p></li><li><p>缩进：统一使用<code>tab</code>四个宫格</p></li><li><p>空格，空行，这个以<code>pycharm</code>格式化为准，快捷键<code>ctrl+alt+l</code></p></li><li><p>行长度：这个以<code>pycharm</code>格式化为准，一般120个字符</p></li><li><p>全局变量和私有变量：少使用全局变量，全局变量使得程序更难理解和使用</p></li><li><p>密码，密钥，token：在日志打印中注重隐私保护，不打印密码，密钥，token</p></li><li><p>一个py文件一般不超过300行</p></li></ul>`,10);function w(q,x){const e=t("ExternalLinkIcon");return i(),o("div",null,[u,n("ul",null,[d,n("li",null,[r,n("ul",null,[k,v,n("li",null,[n("p",null,[n("a",m,[a("函数注释统一使用"),b,a("风格"),l(e)])]),g])])]),h,y,f]),_])}const S=p(c,[["render",w],["__file","个人代码风格.html.vue"]]);export{S as default};
