import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as l,e as a}from"./app-01aedd85.js";const n={},d=a(`<h1 id="_11、缓存淘汰和过期删除" tabindex="-1"><a class="header-anchor" href="#_11、缓存淘汰和过期删除" aria-hidden="true">#</a> 11、缓存淘汰和过期删除</h1><h3 id="一、面试题" tabindex="-1"><a class="header-anchor" href="#一、面试题" aria-hidden="true">#</a> 一、面试题</h3><ul><li><p>redis 默认的内存是多少？在哪里查看？如何设置和修改？</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>查看redis最大占用内存？  config get maxmemory
