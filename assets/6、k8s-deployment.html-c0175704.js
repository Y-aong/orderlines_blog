import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as t,c as r,a as e,b as n,d as i,e as a}from"./app-01aedd85.js";const o={},c=a(`<h1 id="_6、完成一次部署" tabindex="-1"><a class="header-anchor" href="#_6、完成一次部署" aria-hidden="true">#</a> 6、完成一次部署</h1><h3 id="一、定义" tabindex="-1"><a class="header-anchor" href="#一、定义" aria-hidden="true">#</a> 一、定义</h3><p>deployment为pod是和replicaSets提供声明式更新的能力。Delpoyment就是将实际状态变为期望状态的能力</p><h3 id="二、deployment的特点" tabindex="-1"><a class="header-anchor" href="#二、deployment的特点" aria-hidden="true">#</a> 二、deployment的特点</h3><ul><li>赋予Pod自愈和故障转移能力</li><li>水平扩容</li><li>灰度发布</li><li>滚动更新</li></ul><p>三、deployment-spec的字段</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>FIELDS:
