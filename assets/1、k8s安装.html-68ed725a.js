import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-01aedd85.js";const i={},l=e(`<h1 id="_1、安装配置" tabindex="-1"><a class="header-anchor" href="#_1、安装配置" aria-hidden="true">#</a> 1、安装配置</h1><h3 id="一、安装配置" tabindex="-1"><a class="header-anchor" href="#一、安装配置" aria-hidden="true">#</a> 一、安装配置</h3><ul><li><p>3台linux服务器，centos服务器本地设置2核4g</p></li><li><p>三台机器设置组内互信可以互相ping通</p></li><li><p>关闭机器的防火墙</p></li></ul><h3 id="二、基础安装配置" tabindex="-1"><a class="header-anchor" href="#二、基础安装配置" aria-hidden="true">#</a> 二、基础安装配置</h3><p>修改hostname</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 三台机器都要设置</span>
