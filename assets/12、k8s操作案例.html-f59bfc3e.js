import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-48200f17.js";const t={},p=e(`<h1 id="_12、k8s操作案例" tabindex="-1"><a class="header-anchor" href="#_12、k8s操作案例" aria-hidden="true">#</a> 12、k8s操作案例</h1><h3 id="一、多副本操作" tabindex="-1"><a class="header-anchor" href="#一、多副本操作" aria-hidden="true">#</a> 一、多副本操作</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> apps/v1
