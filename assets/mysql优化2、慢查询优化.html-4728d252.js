import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as s,e as a}from"./app-48200f17.js";const i={},l=a(`<h1 id="优化2、慢查询优化" tabindex="-1"><a class="header-anchor" href="#优化2、慢查询优化" aria-hidden="true">#</a> 优化2、慢查询优化</h1><h3 id="慢查询" tabindex="-1"><a class="header-anchor" href="#慢查询" aria-hidden="true">#</a> 慢查询</h3><ol><li><strong>默认情况下 slow_query_log 的值为 OFF，表示慢查询日志是禁用的</strong></li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mysql&gt; show variables like &#39;%slow_query_log%&#39;;
+---------------------+------------------------------+
| Variable_name       | Value                        |
+---------------------+------------------------------+
| slow_query_log      | ON                           |
