import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as i,c,a as n,b as s,d as e,e as t}from"./app-48200f17.js";const o={},u=t(`<h1 id="_10、k8s的存储和配置" tabindex="-1"><a class="header-anchor" href="#_10、k8s的存储和配置" aria-hidden="true">#</a> 10、k8s的存储和配置</h1><h3 id="一、k8s的存储" tabindex="-1"><a class="header-anchor" href="#一、k8s的存储" aria-hidden="true">#</a> 一、k8s的存储</h3><h4 id="_1、必要条件安装nfs-utils" tabindex="-1"><a class="header-anchor" href="#_1、必要条件安装nfs-utils" aria-hidden="true">#</a> 1、必要条件安装nfs-utils</h4><p>所有节点</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 所有机器安装nfs-utils</span>
