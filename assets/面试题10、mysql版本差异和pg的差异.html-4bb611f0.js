import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,e as s}from"./app-58fd5dfd.js";const d={},l=s(`<h1 id="面试题10、-mysql和pg的异同" tabindex="-1"><a class="header-anchor" href="#面试题10、-mysql和pg的异同" aria-hidden="true">#</a> 面试题10、 mysql和pg的异同</h1><h3 id="mysql-5-7和8-0的区别" tabindex="-1"><a class="header-anchor" href="#mysql-5-7和8-0的区别" aria-hidden="true">#</a> <code>mysql 5.7和8.0</code>的区别</h3><h4 id="mysql8-0的新特点" tabindex="-1"><a class="header-anchor" href="#mysql8-0的新特点" aria-hidden="true">#</a> <code>Mysql8.0</code>的新特点</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>使用JSON表函数，您可以使用JSON数据的SQL机制。
