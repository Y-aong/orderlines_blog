import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as s,e as a}from"./app-01aedd85.js";const i={},l=a(`<h1 id="_22、慢查询优化" tabindex="-1"><a class="header-anchor" href="#_22、慢查询优化" aria-hidden="true">#</a> 22、慢查询优化</h1><h3 id="一、慢查询开关" tabindex="-1"><a class="header-anchor" href="#一、慢查询开关" aria-hidden="true">#</a> 一、慢查询开关</h3><ol><li><strong>默认情况下 slow_query_log 的值为 OFF，表示慢查询日志是禁用的</strong></li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mysql&gt; show variables like &#39;%slow_query_log%&#39;;
+---------------------+------------------------------+
| Variable_name       | Value                        |
+---------------------+------------------------------+
| slow_query_log      | ON                           |
