import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as s,e as n}from"./app-48200f17.js";const d={},l=n(`<h1 id="优化1、分页优化" tabindex="-1"><a class="header-anchor" href="#优化1、分页优化" aria-hidden="true">#</a> 优化1、分页优化</h1><h3 id="分页的实现" tabindex="-1"><a class="header-anchor" href="#分页的实现" aria-hidden="true">#</a> 分页的实现</h3><p>一般的分页查询使用简单的 limit 子句就可以实现。limit 格式如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>SELECT * FROM 表名 LIMIT [offset,] rows
